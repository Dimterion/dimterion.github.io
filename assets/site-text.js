export const siteText = {
  en: {
    ...
    footer: {
      ...
      screenNavigation: {
        previous: "Show previous profile section",
        next: "Show next profile section",
      },
    ...
    footer: {
      ...
      languageSwitcher: {
        ...
        aria: {
          ...
          switchTo: "Changer la langue pour : {{language}}",
        },
      },
      ...
      screenNavigation: {
        previous: "Afficher la section de profil précédente",
        next: "Afficher la section de profil suivante",
      },
